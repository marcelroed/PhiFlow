...
obstacle = Obstacle(LevelSet(signed_distance_field, bounds=DOMAIN['bounds']), angular_velocity=0.05, mass=1e3, moment_of_inertia=1e10)
...
sim_grad = field.gradient(simulate, wrt='velocity')
